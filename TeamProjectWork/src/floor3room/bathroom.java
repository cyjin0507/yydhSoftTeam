			...
			public void handle(KeyEvent event) {
				...
				if (keyCode.equals(KeyCode.SPACE)) {
					...
					if ((y == 160) && (x >= 480) && (x <= 580)) {
						...
						try {
							Parent root;
							root = FXMLLoader.load(getClass().getResource("/floor3room_item/mirrorbath.fxml"));
						...
						try {
							Parent root;
							root = FXMLLoader.load(getClass().getResource("/floor3room_item/toilet.fxml"));
							Scene scene = new Scene(root);
							Stage primaryStage = (Stage) imageView.getScene().getWindow();
							primaryStage.setScene(scene);
						} catch (IOException e) {
						...
						try {
							Parent root;
							root = FXMLLoader.load(getClass().getResource("/floor3room_item/shower.fxml"));
							Scene scene = new Scene(root);
							Stage primaryStage = (Stage) imageView.getScene().getWindow();
							primaryStage.setScene(scene);
						} catch (IOException e) {
