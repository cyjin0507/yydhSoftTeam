			...
			public void handle(KeyEvent event) {
				...
				if (keyCode.equals(KeyCode.SPACE)) {
					...
					if ((y == 580) && (x >= 470) && (x <= 630)) {
						...
						try {
							Parent root;
							root = FXMLLoader.load(getClass().getResource("/floor3room_item/mirrorpowder.fxml"));
						...
						try {
							Parent root;
							root = FXMLLoader.load(getClass().getResource("/floor3room_item/cosmeticleft.fxml"));
							Scene scene = new Scene(root);
							Stage primaryStage = (Stage) imageView.getScene().getWindow();
							primaryStage.setScene(scene);
						} catch (IOException e) {
...
//		방 전체 틀 잡기
	...
	public void event() {
		...
		if ((x == 840) && (y <= 380) && (y >= 210)) {
			...
			try {
				Parent root;
				root = FXMLLoader.load(getClass().getResource("/floor3room/bedroom.fxml"));
				Scene scene = new Scene(root);
				Stage primaryStage = (Stage) imageView.getScene().getWindow();
				primaryStage.setScene(scene);
			} catch (IOException e) {
