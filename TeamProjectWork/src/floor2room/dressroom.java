			...
			public void handle(KeyEvent event) {
				...
				if (keyCode.equals(KeyCode.SPACE)) {
					...
					if ((y == 110) && (x <= 250) && (x >= 50)) {
						...
						try {
							Parent root;
							root = FXMLLoader.load(getClass().getResource("/floor2room_item/closet1.fxml"));
					...
					if ((y == 110) && (x <= 510) && (x >= 350)) {
						...
						try {
							Parent root;
							root = FXMLLoader.load(getClass().getResource("/floor2room_item/closet2.fxml"));
							Scene scene = new Scene(root);
							Stage primaryStage = (Stage) imageView.getScene().getWindow();
							primaryStage.setScene(scene);
						} catch (IOException e) {
					...
					if ((y == 110) && (x <= 810) && (x >= 600)) {
						...
						try {
							Parent root;
							root = FXMLLoader.load(getClass().getResource("/floor2room_item/closet3.fxml"));
							Scene scene = new Scene(root);
							Stage primaryStage = (Stage) imageView.getScene().getWindow();
							primaryStage.setScene(scene);
						} catch (IOException e) {
					...
					if ((y == 110) && (x <= 940) && (x >= 880)) {
						...
						try {
							Parent root;
							root = FXMLLoader.load(getClass().getResource("/floor2room_item/closet4.fxml"));
							Scene scene = new Scene(root);
							Stage primaryStage = (Stage) imageView.getScene().getWindow();
							primaryStage.setScene(scene);
						} catch (IOException e) {
					...
					if((x == 30) && (y >= 280) && (y <= 330)){
						...
						try {
							Parent root;
							root = FXMLLoader.load(getClass().getResource("/floor2room_item/mirrorbeforedress.fxml"));
							Scene scene = new Scene(root);
							Stage primaryStage = (Stage) imageView.getScene().getWindow();
							primaryStage.setScene(scene);
						} catch (IOException e) {
